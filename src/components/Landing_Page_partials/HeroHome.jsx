                        ...
                        <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
                            ...
                            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
                                <div className="hidden md:block">
                                    ...
                                    <button type="button" className="btn text-white bg-[color:var(--darker-secondary-color)] hover:bg-[color:var(--secondary-color)] w-full mb-4 sm:w-auto sm:mb-0" onClick={() => signOut()}>
                                        Signout
