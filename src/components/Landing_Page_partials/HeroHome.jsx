          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <Typewriter
              options={{
                ...
                wrapperClassName: "text-2xl text-gray-500 mb-8", // Apply the text style using wrapperClassName
              }}
            />
            <br />
            ...
            {status == "authenticated" && (
              <div className=" md:block">
                <span className="mr-4">Hello, {data.user.firstName}!</span>

                <button
                  type="button"
                  className="btn text-white bg-gradient-to-l from-[color:var(--darker-secondary-color)] to-gray-700 hover:bg-[color:var(--secondary-color)] w-full mb-4 sm:w-auto sm:mb-0"
                  onClick={() => signOut()}
                >
                  Signout
                </button>
