            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between">
                    ...
                    <div class="flex flex-col mt-2 md:mt-4">
                        <button type="button" class="mt-1 btn text-white bg-[color:var(--darker-secondary-color)] hover:bg-[color:var(--secondary-color)] w-full mb-4 sm:w-auto sm:mb-0 whitespace-nowrap" onClick={() => router.push(`/admins/event/statistics/1`)}>
                            Event Statistics
                        </button>
                        
                        <button type="button" class="mt-2 btn text-white bg-[color:var(--darker-secondary-color)] hover:bg-[color:var(--secondary-color)] w-full mb-4 sm:w-auto sm:mb-0 whitespace-nowrap" onClick={() => router.push(`/admins/event/update/1`)}>
                            Update Event
                        </button>
                    </div>
